#' Set up initial cases for branching process (new code)
#' @author Joel Hellewell

outbreak_setup_new <- function(num.initial.cases, incfn, delayfn, k, p_asymptomatic) {
  ...
  # Asymptomatic cases have infinite onset (TODO: Restore this after fixing incubation function)
  # case_data$onset[case_data$asym] <- Inf
