...
# Manual
cowplot::save_plot(filename=snakemake@output[["manual"]],
       plot=contour_manual, ncol=2.5, nrow=3.75, 
       base_height=plot_scale_in, base_asp = 1)

# Hybrid R_eff
cowplot::save_plot(filename=snakemake@output[["hybrid_reff"]],
                   plot=reff_contour_hybrid, ncol=2.5, nrow=3.25,
                   base_height=plot_scale_in, base_asp = 1)

# Hybrid control
cowplot::save_plot(filename=snakemake@output[["hybrid_ctrl"]],
