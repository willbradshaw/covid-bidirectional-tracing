...
# Read in data
scenario_0gen_path <- "saved_data/trace_limit_scenario.tsv.gz"
scenario_4gen_path <- "saved_data/trace_limit_4gen_scenario.tsv.gz"
...
ggsave(filename="saved_data/plot_trace_limits.png",
        plot = g, device="png",
