...
# Universal coverage
univ_path <- "figure_data/si/si_univ_data_500_scenario.tsv.gz"
...
univ_plot_ctrl <- univ_data %>%
  ...
  scale_colour_discrete(labels=label_limits, name=NULL) +
...
# Combine together
univ_plot <- plot_grid(univ_plot_ctrl, univ_plot_reff, 
...
path_prefix <- "figures/si/univ_data_limits"
row_height <- 14
save_fig(path_prefix, ".png", univ_plot, row_height, 0.8*2)
