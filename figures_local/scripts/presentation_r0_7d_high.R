...
data_7d_090_high <- median_data %>%
  filter(contact_limit_manual == 7, p_traced_manual != 0.8,
         p_traced_auto != 0.8, p_smartphone_overall == 0.8)
r0_7d_090_high <- data_7d_090_high %>% combo_plot()
...
save_fig(path_prefix, "_7day_090_high.png", r0_7d_090_high,
