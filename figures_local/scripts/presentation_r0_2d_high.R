...
data_2d_090_high <- median_data %>%
  filter(contact_limit_manual == 2, p_traced_manual != 0.8,
         p_traced_auto != 0.8, trace_neg_symptomatic == TRUE,
         (p_traced_auto == 0 | p_smartphone_overall == 0.8))
r0_2d_090_high <- data_2d_090_high %>% combo_plot()
...
save_fig(path_prefix, "_2day_090_high.png", r0_2d_090_high,
