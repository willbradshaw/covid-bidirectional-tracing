...
median_path <- "figures_local/data/si_window_median_lowasc_1k_scenario.tsv.gz"
median_data <- suppressMessages(read_tsv(median_path)) %>%
  mutate(scenario = "Median scenario")

optim_path <- "figures_local/data/si_window_optimistic_lowasc_1k_scenario.tsv.gz"
optim_data <- suppressMessages(read_tsv(optim_path)) %>%
  mutate(scenario = "Optimistic scenario")

pessim_path <- "figures_local/data/si_window_pessimistic_lowasc_1k_scenario.tsv.gz"
...
path_prefix <- "figures_local/img/si_window_lowasc"
plot_scale_cm <- 11
